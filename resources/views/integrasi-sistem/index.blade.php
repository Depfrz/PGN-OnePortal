    ...
    <div x-data="{ 
        ...
        <div class="flex flex-col lg:flex-row items-center justify-between mb-8 gap-4">
            <div class="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 w-full lg:w-auto">
                ...
                <!-- Add Module Button -->
                @hasrole('Supervisor|Admin')
                <a x-show="!deleteMode" href="{{ url('/integrasi-sistem/create') }}" style="background-color: #16a34a;" class="w-full sm:w-auto text-white text-base font-medium px-6 py-2.5 rounded-lg hover:opacity-90 transition-all shadow-sm hover:shadow text-center">
                    Tambah Modul
                </a>
                @endhasrole
            </div>
            ...
            <!-- Search Bar -->
            <form action="{{ url('/integrasi-sistem') }}" method="GET" class="relative w-full lg:w-[350px]">
            ...
            @forelse($modules as $module)
                ...
                <div :class="deleteMode ? 'border-red-400 bg-red-50 dark:bg-red-900/20 ring-1 ring-red-200 dark:ring-red-900/30' : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-blue-200 dark:hover:border-blue-500 hover:shadow-lg hover:-translate-y-1'"
                    ...
                    <div class="md:self-center flex flex-col items-center gap-2 w-full md:w-auto mt-4 md:mt-0">
                        ...
                        @hasrole('Supervisor|Admin')
                        <a x-show="!deleteMode" href="{{ url('/integrasi-sistem/' . $module->id . '/edit') }}" style="background-color: #eab308;" class="w-full md:w-auto flex items-center justify-center gap-2 text-white px-6 py-2.5 rounded-lg hover:opacity-90 transition-all shadow-sm hover:shadow-md">
                        ...
                        <form x-show="deleteMode" 
                              ...
                              action="{{ url('/integrasi-sistem/' . $module->id) }}" 
                              method="POST" 
