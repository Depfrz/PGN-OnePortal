        ...
        <div class="flex flex-col gap-6">
            @forelse($modules as $module)
                ...
                <div class="border border-black rounded-[15px] p-6 lg:p-8 flex flex-col lg:flex-row items-start gap-6 bg-white transition-shadow hover:shadow-lg">
                    ...
                    <!-- Content -->
                    <div class="flex-1">
                        <h3 class="text-[24px] font-bold text-black mb-2">{{ $module->name }}</h3>
                    ...
                    <div class="lg:self-center flex flex-col items-center gap-2">
                        <a href="{{ $module->url ?? '#' }}" class="flex items-center gap-2 bg-[#30ff07] px-6 py-2 rounded-[10px] border border-transparent hover:border-black transition-all hover:shadow-md">
