    ...
    <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg sticky top-6 h-full md:h-auto overflow-y-auto md:overflow-visible">
            ...
            <nav class="flex flex-col p-3 space-y-1">
                            ...
                            <a href="{{ url('/buku-saku/favorites') }}" 
                            ...
                            @if(auth()->user()->hasModuleAccess('Dokumen Kedaluwarsa'))
                            <a href="{{ url('/buku-saku/expired') }}" 
                               class="flex items-center px-3 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('buku-saku.expired') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 h-5 w-5 {{ request()->routeIs('buku-saku.expired') ? 'text-blue-500' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
