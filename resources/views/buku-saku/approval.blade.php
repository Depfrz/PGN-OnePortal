                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <div class="text-base font-bold text-gray-900">
                                        <a href="{{ url('/buku-saku/preview/' . $doc->id) }}" target="_blank" class="hover:text-blue-600 hover:underline">
                                            {{ $doc->title }}
                                        </a>
                                    </div>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                @if(auth()->user()->id === $doc->user_id || auth()->user()->hasAnyRole(['Admin', 'Supervisor']) || ($hasWriteAccess ?? false))
                                    <!-- Edit Button -->
                                    <a href="{{ url('/buku-saku/edit/' . $doc->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1.5 px-3 rounded text-xs flex items-center transition-colors">
                                    ...
                                    <!-- Delete Button -->
                                    <button type="button" @click="showDeleteModal = true; deleteUrl = '{{ url('/buku-saku/destroy/' . $doc->id) }}'" class="bg-red-500 hover:bg-red-600 text-white font-bold py-1.5 px-3 rounded text-xs flex items-center transition-colors">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <a href="{{ url('/buku-saku/preview/' . $doc->id) }}" target="_blank" class="bg-blue-100 hover:bg-blue-200 text-blue-700 font-bold py-1.5 px-3 rounded text-xs flex items-center transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <a href="{{ url('/buku-saku/download/' . $doc->id) }}" class="text-gray-400 hover:text-gray-600 p-1.5">
