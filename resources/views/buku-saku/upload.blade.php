<x-buku-saku-layout>
    ...
    <form action="{{ url('/buku-saku/store') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                    ...
                    xhr.onreadystatechange = function() {
                        if (xhr.readyState === 4) {
                            ...
                            if (xhr.status === 200) {
                                ...
                                setTimeout(() => {
                                    window.location.href = "{{ url('/buku-saku') }}"; // Redirect manual
                                }, 1000);
            ...
            confirmDeleteBtn.addEventListener('click', function() {
                ...
                const url = "{{ url('/buku-saku/tags') }}/" + id;
