<x-buku-saku-layout>
    ...
    <form action="{{ url('/buku-saku/update/' . $document->id) }}" method="POST" enctype="multipart/form-data" id="uploadForm">
        @csrf
        @method('PUT')
        ...
        <!-- Submit -->
         <div class="flex justify-end gap-3">
            <a href="{{ url('/buku-saku') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-6 rounded-lg shadow transition-colors text-sm">
                Batal
            </a>
