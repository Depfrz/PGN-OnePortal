<x-buku-saku-layout title="Buku Saku">
    ...
    <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm mb-6">
        ...
        <form x-data="{ 
        ...
        }" action="{{ url('/buku-saku') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            <!-- Search Input -->
            ...
            <!-- Checkbox Show Expired -->
            <div class="flex items-center h-full pt-2">
                <label class="inline-flex items-center cursor-pointer">
                    <input type="checkbox" name="show_expired" value="1" {{ request('show_expired') ? 'checked' : '' }} class="rounded border-gray-300 text-red-600 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50 h-5 w-5">
                    <span class="ml-2 text-sm text-gray-700 font-medium">Tampilkan Kedaluwarsa</span>
                </label>
            </div>
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                                            @php
                                                // Edit/Delete buttons removed as per request
                                            @endphp
                                            ...
                                            <a href="{{ url('/buku-saku/download/' . $doc->id) }}" class="p-1 rounded-full hover:bg-gray-100 text-blue-600" title="Unduh">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (searchInput) {
                searchInput.addEventListener('input', function(e) {
                    if (this.value.trim() === '') {
                        window.location.href = "{{ url('/buku-saku') }}";
                    }
                });
            }
        });
