    ...
    <div x-data="{ 
        ...
        <aside :class="{
            ...
            <nav class="flex-1 px-4 space-y-4 mt-4 overflow-y-auto">
                <!-- Dashboard -->
                <a href="{{ url('/dashboard') }}" class="flex items-center px-4 py-3 rounded-xl transition-colors group whitespace-nowrap {{ request()->routeIs('dashboard') ? 'bg-white dark:bg-gray-700 shadow-sm' : 'hover:bg-white/20 dark:hover:bg-gray-700' }}">
                ...
                <a href="{{ url('/history') }}" class="flex items-center px-4 py-3 rounded-xl transition-colors group whitespace-nowrap {{ request()->routeIs('history') ? 'bg-white dark:bg-gray-700 shadow-sm' : 'hover:bg-white/20 dark:hover:bg-gray-700' }}">
                    <div class="w-8 h-8 flex items-center justify-center mr-4 shrink-0">
                        <!-- History Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-black dark:text-white group-hover:text-black dark:group-hover:text-white transition-colors">
                    ...
                    <span class="text-sm font-bold text-black dark:text-white group-hover:text-black dark:group-hover:text-white transition-colors">History Aktivitas</span>
                </a>
                @endcan

                <!-- Management User -->
                @can('view module management-user')
                <a href="{{ url('/management-user') }}" class="flex items-center px-4 py-3 rounded-xl transition-colors group whitespace-nowrap {{ request()->is('management-user*') ? 'bg-white dark:bg-gray-700 shadow-sm' : 'hover:bg-white/20 dark:hover:bg-gray-700' }}">
                    <div class="w-8 h-8 flex items-center justify-center mr-4 shrink-0">
                        <!-- User Group Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-black dark:text-white group-hover:text-black dark:group-hover:text-white transition-colors">
                ...
                <a href="{{ url('/integrasi-sistem') }}" class="flex items-center px-4 py-3 rounded-xl transition-colors group whitespace-nowrap {{ request()->is('integrasi-sistem*') ? 'bg-white dark:bg-gray-700 shadow-sm' : 'hover:bg-white/20 dark:hover:bg-gray-700' }}">
                    <div class="w-8 h-8 flex items-center justify-center mr-4 shrink-0">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    class="relative">
                        ...
                        <div x-show="open" 
                            ...
                            <!-- Footer -->
                            <a href="{{ request()->routeIs('buku-saku.*') ? url('/buku-saku/history') : url('/history') }}" class="block w-full py-3 text-center text-xs font-semibold text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-gray-700 border-t border-gray-100 dark:border-gray-700 transition-colors">
                                Lihat Data History
                            </a>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false, logoutConfirmOpen: false }" class="relative">
                        ...
                        <div x-show="open" 
                            ...
                            <!-- Settings -->
                            <a href="{{ url('/profile') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-150">
                                Settings
                            </a>
