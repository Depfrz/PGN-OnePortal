  ...
  return (
    <div className={styles.integrasiSystemDataT}>
      <div className={styles.autoWrapper8}>
        <div className={styles.rectangle18}>
          ...
          <div className={styles.autoWrapper7}>
            <div className={styles.rectangle6}>
              ...
              <img
                src="https://via.placeholder.com/38x44"
            ...
            <div className={styles.rectangle42}>
              ...
              <div className={styles.autoWrapper5}>
                ...
                <div className={styles.rectangle45}>
                  <p className={styles.hapusModul}>Cancel</p>
                </div>
              ...
              <div className={styles.rectangle47}>
                <div className={styles.group21}>
                  <div className={styles.rectangle51}>
                    ...
                    <p className={styles.platformDigitalTerin}>
                      ...
                      layanan mandiri (Employee Self-Service) bagi seluruh pekerja
                      di lingkungan PT Pertamina Gas Negara Tbk. Sistem ini
                      dirancang untuk mendigitalkan seluruh siklus administrasi
                      kepegawaian, mulai dari pengelolaan data personal, manajemen
                      waktu kerja, hingga remunerasi.
                      <br />
                ...
                <div className={styles.group26}>
                  <div className={styles.rectangle512}>
                    <div className={styles.group24}>
                      <div className={styles.image3} />
                    </div>
                    <p className={styles.hCmsippgn}>HCM SIP-PGN</p>
                    <p className={styles.platformDigitalTerin2}>
                      platform digital terintegrasi yang berfungsi sebagai pusat
                      layanan mandiri (Employee Self-Service) bagi seluruh pekerja
                      di lingkungan PT Pertamina Gas Negara Tbk. Sistem ini
                      dirancang untuk mendigitalkan seluruh siklus administrasi
                ...
                <div className={styles.group22}>
                  <div className={styles.rectangle513}>
                    <div className={styles.group24}>
                      <div className={styles.image3} />
                    </div>
                    <p className={styles.hCmsippgn2}>HCM SIP-PGN</p>
                    <p className={styles.platformDigitalTerin3}>
                      platform digital terintegrasi yang berfungsi sebagai pusat
                      layanan mandiri (Employee Self-Service) bagi seluruh pekerja
                      di lingkungan PT Pertamina Gas Negara Tbk. Sistem ini
                      dirancang untuk mendigitalkan seluruh siklus administrasi
                ...
                <div className={styles.rectangle55}>
                  <p className={styles.apakahAndaYakinIngin}>
                    Apakah Anda yakin ingin menghapus Sistem “HCM SIP-PGN”?
                  </p>
        ...
        <p className={styles.supervisor2}>Supervisor</p>
      </div>
