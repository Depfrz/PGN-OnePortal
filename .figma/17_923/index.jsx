...
const Component = () => {
  return (
    <div className={styles.adminMengeklikGantiP}>
        ...
        <div className={styles.halamanAdmin}>
          ...
          <div className={styles.autoWrapper8}>
            <div className={styles.rectangle6}>
              <p className={styles.berandaManagementUse}>
                Beranda →Management User
              </p>
            ...
            <div className={styles.rectangle11}>
              ...
              <div className={styles.rectangle14}>
                ...
                <div className={styles.rectangle21}>
                  ...
                  <p className={styles.namaEmail2}>Nama/Email</p>
                  <p className={styles.passwordBaru}>Password baru</p>
                  <div className={styles.autoWrapper7}>
                    <div className={styles.rectangle232} />
                    <div className={styles.rectangle25}>
                      <p className={styles.setuju}>Setuju</p>
                    </div>
                  </div>
