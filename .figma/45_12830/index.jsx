    ...
    <div className={styles.integrasiSystemTamba}>
      <div className={styles.rectangle18}>
        <div className={styles.rectangle13}>
          <img
            src="../image/mkmako3p-ud4ucdz.png"
            className={styles.logoPertaminaGasNega}
          />
          <div className={styles.autoWrapper}>
            <div className={styles.lineMdHomeTwotone}>
              <img src="../image/mkmako3n-vzl4mbx.svg" className={styles.vector} />
              <img src="../image/mkmako3o-ve1aju4.svg" className={styles.group} />
              <img
                src="../image/mkmako3o-ycgw6v2.svg"
          ...
          <div className={styles.autoWrapper2}>
            <img
              src="../image/mkmako3o-xj3z4ve.svg"
          ...
          <div className={styles.rectangle16}>
            ...
            <div className={styles.rectangle17}>
              <img src="../image/mkmako3o-070utwe.svg" className={styles.vector2} />
        ...
        <div className={styles.autoWrapper6}>
          <div className={styles.rectangle6}>
            <img src="../image/mkmako3o-ffzc94x.svg" className={styles.group2} />
            <div className={styles.autoWrapper3}>
              <p className={styles.dashboardIntegrasiSi}>
                Dashboard → Integrasi Sistem
              </p>
              <img src="../image/mkmako3o-w2p2d3l.svg" className={styles.vector3} />
          ...
          <div className={styles.rectangle42}>
            <div className={styles.autoWrapper4}>
              <img
                src="../image/mkmako3o-08ap34m.svg"
                className={styles.materialSymbolsHisto}
              />
            ...
            <div className={styles.rectangle47}>
              ...
              <div className={styles.autoWrapper5}>
                ...
                <img
                  src="../image/mkmako3o-0e8ob2m.svg"
              ...
              <img
                src="../image/mkmako3o-orh5rrq.svg"
